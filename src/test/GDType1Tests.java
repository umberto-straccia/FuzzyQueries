...
public class GDType1Tests {
    ...
    public void testGDType1() throws Exception {
        ...
        FuzzyQuery fq = new GDType1(
                odp, few, wine, lowPriceWine, hasPriceWine);
        assertEquals(0.6, fq.run());
    }

    @Test
    @DisplayName("Test GD Type I - Few(Left(3,5)) of hotels are LowPrice")
    public void testGDType1_2() throws Exception {
        ...
        FuzzyQuery fq = new GDType1(odp, few, hotel, lowPriceHotel, priceHotel);

        assertEquals(0.75, fq.run());
    }
}
